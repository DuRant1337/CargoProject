...
public class UnitisedCargoImpl extends StorableCargos implements UnitisedCargo {

    public UnitisedCargoImpl(BigDecimal value, List<Hazard> hazards, Customer owner,
                             Duration storageDuration, Date lastInspectionDate,
                             int storageLocation, boolean fragile) {
        super(value, hazards, owner, storageDuration, lastInspectionDate, storageLocation, new Date(), false, fragile, null);
    }

    @Override
    public boolean isFragile() {
        return super.isFragile();
    }
